 ...
 function contact_form_plugin()
{
    ...
    $content .= '<form method="post" action="http://fullwptheme.local/thank-you/"';
    ...
    $content .= '<br><input type="submit" name="contact_form_submit" class="btn btn-lg btn-primary" value="Submit Message">';
    $content .= '</form>';    
    return $content;
